...
<html>
   <head>
      ...
      <style media="screen">
         ...
         left: 4px; /* adjust this value to center the checkmark horizontally */
         top: 2px; /* adjust this value to center the checkmark vertically */
         width: 5px;
         height: 10px;
         border: solid #059f3e;
         ...
         .beri-suara {
            background-color: white; /* initial green color */
            color: #0b9a03;
            position: relative;
            bottom: 10px;
         }
